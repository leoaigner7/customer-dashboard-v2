...
export default function StatusPage() {
  ...
  <h3 style={{ margin: 0 }}>Version 7.1.7 – Neue Funktion aktiviert</h3>
  <p style={{ margin: 0 }}>Dieses Banner erscheint nur in Version 7.1.7 Damit kannst du Auto-Updates sofort prüfen.</p>
</div>
