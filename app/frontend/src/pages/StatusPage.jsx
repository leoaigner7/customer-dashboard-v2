...
export default function StatusPage() {
  ...
  <h3 style={{ margin: 0 }}>Version 6.7.5 – Neue Funktion aktiviert</h3>
  <p style={{ margin: 0 }}>Dieses Banner erscheint nur in Version 6.7.5 Damit kannst du Auto-Updates sofort prüfen.</p>
</div>
